<div ng-controller="OtherActivitiesQueryController">
	...
	<div layout="row">
	  ...
	  <div flex-offset="5" flex="70">
		...
		<div class="api_urls" ng-if=" !state.data_loading ">
			...
			<div>
				<!-- Target -->
				<input type="text" id="api-csv-other-activities" readonly ng-value="data.api_urls.csv">

				<!-- Trigger -->
				<button class="btn" ngclipboard data-clipboard-target="#api-csv-other-activities">
				    Copy to clipboard
				</button>
			</div>
			...
			<div>
				<!-- Target -->
				<input type="text" id="api-json-other-activities" readonly ng-value="data.api_urls.json">

				<!-- Trigger -->
				<button class="btn" ngclipboard data-clipboard-target="#api-json-other-activities">
				    Copy to clipboard
				</button>
			</div>
