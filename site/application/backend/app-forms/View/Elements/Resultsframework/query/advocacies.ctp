<div ng-controller="AdvocaciesQueryController">
	...
	<div layout="row">
	  ...
	  <div flex-offset="5" flex="70">
		...
		<div class="api_urls" ng-if=" !state.data_loading ">
			...
			<div>
				<!-- Target -->
				<input type="text" id="api-csv-advocacies" readonly ng-value="data.api_urls.csv">

				<!-- Trigger -->
				<button class="btn" ngclipboard data-clipboard-target="#api-csv-advocacies">
				    Copy to clipboard
				</button>
			</div>
			...
			<div>
				<!-- Target -->
				<input type="text" id="api-json-advocacies" readonly ng-value="data.api_urls.json">

				<!-- Trigger -->
				<button class="btn" ngclipboard data-clipboard-target="#api-json-advocacies">
				    Copy to clipboard
				</button>
			</div>
